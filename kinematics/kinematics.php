...
<head>
	...
	<link type='text/css' rel="stylesheet" href="kinematics.css">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<div class="pages-nav animated bounceInDown" id="top-pager">
						<ul class="pager">
							<li><a href="../acceleration/acceleration.php" class="prev-page-btn"><span class="glyphicon glyphicon-chevron-left"></span>Previous: Acceleration</a></li>
							<li><a href="../circular-motion/circular-motion.php" class="next-page-btn">Next: Circular Motion<span class="glyphicon glyphicon-chevron-right"></span></a></li>
						</ul>
					</div>
				</div>
			</div>
								...
								<div class="col-md-8 text-center">
									...
									<div id="outer-image-container">
										<div id="inner-image-container">
											<img src="../images/kinematics/bigFiveOne.PNG" class="img-responsive slide" alt="d = (v)(t)"/>
											<img src="../images/kinematics/bigFiveTwo.PNG" class="img-responsive slide" alt="Cos Equation"/>
											<img src="../images/kinematics/bigFiveThree.PNG" class="img-responsive slide" alt="Tan Equation"/>
											<img src="../images/kinematics/bigFiveFour.PNG" class="img-responsive slide" alt="Inv Sin Equation"/>
											<img src="../images/kinematics/bigFiveFive.PNG" class="img-responsive slide" alt="Inv Cos Equation"/>
										</div>
									...
									<div id="solo-image">
										<img src="../images/kinematics/equationImageTemplate.PNG" class="img-responsive" alt="Trig Triangle"/>
										<div class="car-icon" id="car-icon-one"><img src="../images/kinematics/automobile.png" alt="Car"></div>
										<div class="car-icon" id="car-icon-two"><img src="../images/kinematics/automobile.png" alt="Car"></div>
										<div class="car-icon" id="car-icon-three"><img src="../images/kinematics/automobile.png" alt="Car"></div>
										<img src="../images/kinematics/streetlight.png" id="street-light-img"/>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body module-section">
							...
							<div class="module-img">
								<img src="../images/kinematics/bigFiveModuleImage.PNG" class="img-responsive" alt="Big Five Equations">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel-body" id="third-panel">
					<div class="row animated fadeInLeft" id="third-pics-row">
						<div class="col-sm-4 third-page-pics">
							<img src="../images/kinematics/blue-angel.jpeg" alt="Blue Angel Jet" class="img-responsive">
						...
						<div class="col-sm-4 third-page-pics">
							<img src="../images/kinematics/hockey.jpg" alt="Hockey" class="img-responsive">
							<div class="img-caption">
						...
						<div class="col-sm-4 third-page-pics">
							<img src="../images/kinematics/trains.jpg" alt="Trains" class="img-responsive">
							<div class="img-caption">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<button class="accordion first-accordion"><strong>Problem</strong></button>
									...
									<div class="modal-panel">
										<img src="../images/kinematics/kinematicsAccordionImg1.PNG" alt="Angle Throw" class="img-responsive"/>
									</div>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<button class="accordion first-accordion"><strong>Problem</strong></button>
									...
									<button class="accordion"><strong>Illustration</strong></button>
									<div class="modal-panel">
										<img src="../images/kinematics/kinematicsAccordionImg2.PNG" alt="Cliff kick ball"  class="img-responsive"/>
									</div>
									<button class="accordion last-accordion"><strong>Solution</strong></button>
									<div class="modal-panel">
										<p>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<button class="accordion first-accordion"><strong>Problem</strong></button>
									...
									<button class="accordion"><strong>Illustration</strong></button>
									<div class="modal-panel">
										<img src="../images/kinematics/kinematicsAccordionImg3.PNG" alt="Parabolic Path"  class="img-responsive"/>
									</div>
									<button class="accordion last-accordion"><strong>Solution</strong></button>
									<div class="modal-panel">
										<p>
