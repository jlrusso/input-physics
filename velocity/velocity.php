		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<div class="pages-nav animated bounceInDown" id="top-pager">
						<ul class="pager">
							<li><a href="../vector-displacement/vector-displacement.php" class="prev-page-btn"><span class="glyphicon glyphicon-chevron-left"></span>Previous: 2D Displacement</a></li>
							<li><a href="../acceleration/acceleration.php" class="next-page-btn">Next: Acceleration<span class="glyphicon glyphicon-chevron-right"></span></a></li>
						</ul>
					</div>
				</div>
								...
								<div class="col-md-8 text-center">
									...
									<div id="outer-image-container">
										<div id="inner-image-container">
											<img src="../images/velocity/newVelocityEquation.PNG" class="img-responsive slide" alt="Velocity Equation"/>
											<img src="../images/velocity/newDisplacementEquation.PNG" class="img-responsive slide" alt="Displacement Equation"/>
											<img src="../images/velocity/newTimeIntervalEquation.PNG" class="img-responsive slide" alt="Time Interval Equation"/>
										</div>
									...
									<div id="solo-image">
										<img src="../images/velocity/newVelocityFrames.PNG" class="img-responsive" alt="Velocity Frames"/>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body module-section">
							...
							<div class="module-img">
								<img src="../images/velocity/positionVTimeGraph.PNG" class="img-responsive" alt="Position v. Time Graph">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel-body" id="third-pics-panel">
					<div class="row animated fadeInLeft" id="third-pics-row">
						<div class="col-sm-4 third-page-pics">
							<img src="../images/velocity/tourDeFrance.jpeg" alt="Bike Race" class="img-responsive">
						...
						<div class="col-sm-4 third-page-pics">
							<img src="../images/velocity/swimmer.jpeg" alt="Swimmer" class="img-responsive">
							<div class="img-caption">
						...
						<div class="col-sm-4 third-page-pics">
							<img src="../images/velocity/cheetah.jpg" alt="Cheetah" class="img-responsive">
							<div class="img-caption">
		  ...
		  ?>
			...
			<div class="modal fade example-modal" id="my-modal-one" role="dialog">
              ...
              <div class="modal-panel">
                  <img src="../images/velocity/velocityAccordionImg1.PNG" alt="Bowling"/>
              </div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<button class="accordion"><strong>Illustration</strong></button>
							<div class="modal-panel">
								<img src="../images/velocity/velocityAccordionImg2.PNG" alt="Perimeter"/>
							</div>
							<button class="accordion last-accordion"><strong>Solution</strong></button>
							<div class="modal-panel">
								<p>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<button class="accordion"><strong>Illustration</strong></button>
							<div class="modal-panel">
								<img src="../images/velocity/velocityAccordionImg3.PNG" alt="Ball Thrown"/>
							</div>
							<button class="accordion last-accordion"><strong>Solution</strong></button>
							<div class="modal-panel">
								<p>
