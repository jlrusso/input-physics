...
<head>
	...
	<link type='text/css' rel="stylesheet" href="acceleration.css">
</head>
<body>
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					...
					<div class="pages-nav animated bounceInDown" id="top-pager">
						<ul class="pager">
							<li><a href="../velocity/velocity.php" class="prev-page-btn"><span class="glyphicon glyphicon-chevron-left"></span>Previous: Velocity</a></li>
							<li><a href="../kinematics/kinematics.php" class="next-page-btn">Next: Kinematics<span class="glyphicon glyphicon-chevron-right"></span></a></li>
						</ul>
					</div>
				</div>
			</div>
								...
								<div class="col-md-8 text-center">
									...
									<div id="outer-image-container">
										<div id="inner-image-container">
											<img src="../images/acceleration/accl-equation-one.PNG" class="img-responsive slide" alt="Accl Equation 1"/>
											<img src="../images/acceleration/accl-equation-two.PNG" class="img-responsive slide" alt="Accl Equation 2"/>
											<img src="../images/acceleration/accl-equation-three.PNG" class="img-responsive slide" alt="Accl Equation 3"/>
										</div>
									...
									<div id="solo-image">
										<img src="../images/acceleration/solo-accl-image.PNG" class="img-responsive" alt="Acceleration Graph"/>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body module-section">
							...
							<div class="module-img">
								<img src="../images/acceleration/acceleration-graph.PNG" class="img-responsive" alt="Pythagorean Triangle">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel-body" id="third-pics-panel">
					<div class="row animated fadeInLeft">
						<div class="col-sm-4 third-page-pics">
							<img src="../images/acceleration/rocket-launch.jpeg" alt="Rocket Launch" class="img-responsive">
						...
						<div class="col-sm-4 third-page-pics">
							<img src="../images/acceleration/formula-one.jpeg" alt="Formula 1 Car" class="img-responsive">
							<div class="img-caption">
						...
						<div class="col-sm-4 third-page-pics">
							<img src="../images/acceleration/roller-coaster.jpg" alt="Apple" class="img-responsive">
							<div class="img-caption">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="modal-panel">
								<img src="../images/acceleration/accelerationAccordionImg1.PNG" alt="Car deceleration" class="img-responsive"/>
							</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<button class="accordion"><strong>Illustration</strong></button>
								<div class="modal-panel">
									<img src="../images/acceleration/accelerationAccordionImg2.PNG" alt="Car deceleration" class="img-responsive"/>
								</div>
								<button class="accordion last-accordion"><strong>Solution</strong></button>
								<div class="modal-panel">
									<p>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<button class="accordion"><strong>Illustration</strong></button>
								<div class="modal-panel">
									<img src="../images/acceleration/accelerationAccordionImg3.PNG" alt="Car deceleration" class="img-responsive"/>
								</div>
								<button class="accordion last-accordion"><strong>Solution</strong></button>
								<div class="modal-panel">
									<p>
