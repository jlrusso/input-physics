...
<head>
	...
	<link type='text/css' rel="stylesheet" href="circular-motion.css">
</head>
<body>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<div class="pages-nav animated bounceInDown">
						<ul class="pager">
							<li><a href="../kinematics/kinematics.php" class="prev-page-btn"><span class="glyphicon glyphicon-chevron-left"></span>Previous: Kinematics Big Five</a></li>
							<li><a href="../forces/forces.php" class="next-page-btn">Next: Forces<span class="glyphicon glyphicon-chevron-right"></span></a></li>
						</ul>
					</div>
				</div>
			</div>
								...
								<div class="col-md-8 text-center">
									...
									<div id="outer-image-container">
										<div id="inner-image-container">
											<img src="../images/circular-motion/circular-equation-one.PNG" class="img-responsive slide" alt="Angular Velocity"/>
											<img src="../images/circular-motion/circular-equation-two.PNG" class="img-responsive slide" alt="Period"/>
											<img src="../images/circular-motion/circular-equation-three.PNG" class="img-responsive slide" alt="Radius"/>
											<img src="../images/circular-motion/circular-frequency-equation.PNG" class="img-responsive slide" alt="Frequency"/>
											<img src="../images/circular-motion/circular-period-equation.PNG" class="img-responsive slide" alt="Period"/>
										</div>
									...
									<div id="solo-image">
										<img src="../images/circular-motion/circular-motion-solo-pic.PNG" class="img-responsive" alt="Acceleration Graph"/>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body module-section">
							...
							<div class="module-img">
								<img src="../images/circular-motion/circular-module-image.PNG" class="img-responsive" alt="Circular Motion Diagram">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel-body" id="third-pics-panel">
					<div class="row animated fadeInLeft">
						<div class="col-sm-4 third-page-pics">
							<img src="../images/circular-motion/turbine.jpeg" alt="Plane Turbine" class="img-responsive">
						...
						<div class="col-sm-4 third-page-pics">
							<img src="../images/circular-motion/hard-drive.jpg" alt="Formula 1 Car" class="img-responsive">
							<div class="img-caption">
						...
						<div class="col-sm-4 third-page-pics">
							<img src="../images/circular-motion/car-dashboard.jpeg" alt="Apple" class="img-responsive">
							<div class="img-caption">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="modal-panel">
								<img src="../images/circular-motion/circularMotionAccordionImg1.PNG" class="img-responsive"/>
							</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<button class="accordion"><strong>Illustration</strong></button>
								<div class="modal-panel">
									<img src="../images/circular-motion/circularMotionAccordionImg2.PNG" class="img-responsive"/>
								</div>
								<button class="accordion last-accordion"><strong>Solution</strong></button>
								<div class="modal-panel">
									<p>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<button class="accordion"><strong>Illustration</strong></button>
								<div class="modal-panel">
									<img src="../images/circular-motion/circularMotionAccordionImg3.PNG" class="img-responsive"/>
								</div>
								<button class="accordion last-accordion"><strong>Solution</strong></button>
								<div class="modal-panel">
									<p>
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	<script type="text/javascript" src="circular-motion.js"></script>
