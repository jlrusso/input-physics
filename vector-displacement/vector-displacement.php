...
<head>
	...
	<title>IP | Vector Displacement</title>
	...
	<link type='text/css' rel="stylesheet" href="vector-displacement.css">
	<link type='text/css' rel='stylesheet' href='../includes/topic-search.css'>
...
<body>
	...
	<?php
		...
		include_once "../includes/topic-search.php";
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 text-center">
					<h2 class="animated bounceInDown section-heading">Vector Displacement</h2>
					<div class="pages-nav animated bounceInDown" id="top-pager">
						<ul class="pager">
							<li><a href="../displacement/displacement.php" class="prev-page-btn"><span class="glyphicon glyphicon-chevron-left"></span>Previous: Displacement</a></li>
							<li><a href="../velocity/velocity.php" class="next-page-btn">Next: Velocity<span class="glyphicon glyphicon-chevron-right"></span></a></li>
						</ul>
					</div>
				</div>
			</div>
								...
								<div class="col-md-8 text-center">
									...
									<div id="outer-image-container">
										<div id="inner-image-container">
											<img src="../images/vector-displacement/newSinEquation.PNG" class="img-responsive slide" alt="Sin Equation"/>
											<img src="../images/vector-displacement/newCosEquation.PNG" class="img-responsive slide" alt="Cos Equation"/>
											<img src="../images/vector-displacement/newTanEquation.PNG" class="img-responsive slide" alt="Tan Equation"/>
											<img src="../images/vector-displacement/newInvSinEquation.PNG" class="img-responsive slide" alt="Inv Sin Equation"/>
											<img src="../images/vector-displacement/newInvCosEquation.PNG" class="img-responsive slide" alt="Inv Cos Equation"/>
											<img src="../images/vector-displacement/newInvTanEquation.PNG" class="img-responsive slide" alt="Inv Tan Equation"/>
										</div>
									...
									<div id="solo-image">
										<img src="../images/vector-displacement/newTrigTriangle.PNG" class="img-responsive" alt="Trig Triangle"/>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body module-section">
							...
							<div class="module-img">
								<img src="../images/vector-displacement/pythagoreanTriangle.PNG" class="img-responsive" alt="Pythagorean Triangle">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel-body" id="third-panel-body">
					<div class="row animated fadeInLeft" id="third-pics-row">
						<div class="col-sm-4 third-page-pics">
							<img src="../images/vector-displacement/baseballHit.jpg" alt="Baseball Hit" class="img-responsive">
						...
						<div class="col-sm-4 third-page-pics">
							<img src="../images/vector-displacement/skiJump.jpeg" alt="Ski Jump" class="img-responsive">
							<div class="img-caption">
						...
						<div class="col-sm-4 third-page-pics">
							<img src="../images/vector-displacement/javelinThrow.jpg" alt="Javelin Throw" class="img-responsive">
							<div class="img-caption">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="modal-panel">
									<img src="../images/vector-displacement/vector-accordion-pic.PNG" alt="Vector Image"/>
							</div>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<button class="accordion first-accordion"><strong>Problem</strong></button>
									...
									<button class="accordion"><strong>Illustration</strong></button>
									<div class="modal-panel">
										<img src="../images/vector-displacement/vectorDisplacementAccordionImg2.PNG" alt="Vector Image"/>
									</div>
									<button class="accordion last-accordion"><strong>Solution</strong></button>
									<div class="modal-panel">
										<p>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<button class="accordion first-accordion"><strong>Problem</strong></button>
									...
									<button class="accordion"><strong>Illustration</strong></button>
									<div class="modal-panel">
										<img src="../images/vector-displacement/vectorDisplacementAccordionImg3.PNG" alt="Vector Image"/>
									</div>
									<button class="accordion last-accordion"><strong>Solution</strong></button>
									<div class="modal-panel">
										<p>
  ...
  <script type="text/javascript" src="../includes/topic-calc.js"></script>
	<script type="text/javascript" src="vector-displacement.js"></script>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
